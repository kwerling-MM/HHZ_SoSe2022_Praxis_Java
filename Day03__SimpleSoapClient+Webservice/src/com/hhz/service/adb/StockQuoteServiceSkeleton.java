 ...
 * under the License.
 */
package com.hhz.service.adb;
import com.hhz.service.adb.xsd.GetPriceResponse;
import com.hhz.service.adb.xsd.Update;
import com.hhz.service.adb.xsd.GetPrice;
...
public class StockQuoteServiceSkeleton implements StockQuoteServiceSkeletonInterface {
    ...
    public void update(Update param0) {
        ...
        map.put(param0.getSymbol(), Double.valueOf(param0.getPrice()));
    }
